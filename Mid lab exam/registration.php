...
if (isset($_POST['submit'])) {
    ...
    if (empty($firstName)) {
        ...
        if (count($nameLen) < 2) {
            $firstNameError = 'First Name cannot be less than 2 words';
        }
        else {
                for ($i = 0; $i < strlen($firstName); $i++) {
                    ...
                    if (!ctype_alnum($char) && $char != '.' && $char != '-' && $char != '_') {
                        $firstNameError = "First Name must contain alphanumeric characters, period, dash, or underscore only";
                        break;
                    }
                }
            }
    ...
    if (empty($lastName)) {
        ...
        if (count($nameLen) > 1) {
            $lastNameError = 'Last Name cannot be more than 1 word';
        }
        else {
                for ($i = 0; $i < strlen($lastName); $i++) {
                    ...
                    if (!ctype_alnum($char) && $char != '.' && $char != '-' && $char != '_') {
                        $lastNameError = "Last Name must contain alphanumeric characters, period, dash, or underscore only";
                        break;
                    }
                }
            }
